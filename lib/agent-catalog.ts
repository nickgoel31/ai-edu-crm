...
export const AGENT_CATALOG: AgentCatalogEntry[] = [
  {
    ...
    name: "Inbound Call Receiver",
    description: "Answers every inbound call to the org's main number, greets the caller, and routes or logs the inquiry — the AI front desk for your admissions line.",
  },
  {
    role: AgentRole.LEAD_TELECALLER,
    name: "Lead Telecaller",
    description: "Calls new inbound leads, qualifies eligibility, and books a campus demo visit.",
  },
  {
  ...
  },
  {
    ...
    name: "Counsellor",
    description: "Website live-chat assistant answering admissions FAQs and routing to a human counselor.",
  },
  {
    role: AgentRole.LEAD_QUALIFICATION,
    name: "Lead Qualification",
    description: "Scores inbound leads on budget, eligibility, and intent before counselor handoff.",
  },
  {
    role: AgentRole.REENGAGEMENT,
    name: "Re-engagement",
    description: "Pings stale or lost leads with new scholarships/offers to win them back.",
  },
  {
  ...
  },
  {
    ...
    description: "Chases students for pending required documents until their file is complete.",
  },
  {
    role: AgentRole.PAYMENT_REMINDER,
    name: "Payment Reminder",
    description: "Reminds students of upcoming and overdue installments before escalating to staff.",
  },
  {
  ...
  },
  {
    ...
    description: "Triages student support calls and escalates unresolved issues to campus staff.",
  },
  {
  ...
  },
  {
    ...
    description: "Asks alumni for referrals and tracks incentive payouts for successful admissions.",
  },
];
